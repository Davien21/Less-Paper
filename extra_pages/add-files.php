...
<html>
	...
	<body>
				...
				<div id="display-modal" class="col-11 col-sm-9 col-md-8 col-lg-7 col-xl-7 mx-auto mt-5 bg-white rounded modal-box-shadow">
					<div class="p-2">
						<div class=" px-0 pr-sm-2 col-12 flex pb-1 border-bottom flex-column flex-sm-row">
							<h3 id="header-dept-page" class="p-0 m-0 col-auto">
								<span class="d-none d-sm-inline-block">Your</span> 
								<span class="">Departments</span>
							</h3>
							<h4 id="confirm-dept-page" class="p-0 m-0 col-auto">
								<span>Confirm</span>
							...
							<div id="edit-ops-div" class="col-12 col-sm-auto mx-auto my-2 mt-sm-0">
								<button class="btn btn-outline-info edit-depts-btn  d-inline-block">
									<span>Edit Data</span>
								</button>
						...
						<div id="dept-output-table" class="table-responsive stable-height">
							<table class="table no-word-wrap all-depts table-hover table-condensed">
								<thead class="relative">
									...
									<tbody id="dept-output" class=" pb-3 pb-sm-4 dept-output">
		...
		<main>
			<section id="add-departments-section">
					...
					<div class="row mb-5 ">
						<div class="mx-auto col-12 col-sm-9 col-md-7 col-lg-5 col-xl-4 ">
							<div class="d-block rounded material-box py-1 alert-navy-blue ">
								...
								<span class="dept-counter rounded">?</span>
